<template>
  <div class="mx-4 my-2 flex flex-col items-center bg-gray-800 relative">
    ...
    <footer class="w-[90%] h-[5%] mx-4 my-4 p-2 flex items-center justify-between absolute bottom-0">
      <div class="flex">
        <!-- Reset -->
        <ButtonIcon class="mr-2 w-8 h-8" @click="reset()" :title="'Reset'">
        ...
        <!-- BackPC -->
        <ButtonIcon class="mr-2 w-8 h-8" @click="backPC()" :title="'Last PC'">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
            <path fill="currentColor"
        ...
        <!-- BackPiece -->
        <ButtonIcon class="mr-2 w-8 h-8" @click="backPiece()" :title="'Last Piece'">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
            <path fill="currentColor"
        ...
        <!-- ForwardPiece -->
        <ButtonIcon class="mr-2 w-8 h-8" @click="forwardPiece()" :title="'Next Piece'">
        ...
        <!-- ForwardPC -->
        <ButtonIcon class="mr-2 w-8 h-8" @click="forwardPC()" :title="'Next PC'">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" class="inline-block">
            <path fill="currentColor"
